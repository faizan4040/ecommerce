...
//         ? `${process.env.NEXT_PUBLIC_API_URL}${products[0].variantId.media[0].url}`
//         : "/placeholder.png";

//     const productName = products?.[0]?.productId?.name || "Product";
//     const sku = products?.[0]?.variantId?.sku || "SKU";
...
//             unoptimized={true} // allows external URLs
//           />
//         </div>
//       </div>
//     );
